...
export default function Landing() {
    return (
        <div className="min-h-screen bg-light overflow-hidden text-dark">
            {/* Hero Section */}
                ...
                <div className="max-w-7xl mx-auto px-6 relative">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="space-y-8 animate-in slide-in-from-left duration-700">
                            ...
                            <p className="text-xl text-gray max-w-lg leading-relaxed">
                            ...
                            <div className="flex items-center gap-4 text-sm text-gray font-medium pt-8">
                                <div className="flex -space-x-2">
                                    {[1, 2, 3, 4].map(i => (
                                        <div key={i} className="w-8 h-8 rounded-full border-2 border-white bg-border flex items-center justify-center text-[10px] font-bold text-gray">
                                            U{i}
                                        </div>
                                    ))}
                                </div>
                        ...
                        <div className="relative lg:block animate-in slide-in-from-right zoom-in-95 duration-1000">
                            <div className="relative bg-white rounded-[2rem] shadow-2xl border border-border p-2 overflow-hidden">
                                <img
                                ...
                                />
                                {/* Floating Badges */}
                                <div className="absolute top-10 -right-4 bg-white p-4 rounded-2xl shadow-xl border border-border animate-bounce duration-[3000ms]">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-full bg-success flex items-center justify-center text-white">
                                            <ShoppingBag size={20} />
                                        </div>
                                        <div>
                                            <p className="text-[10px] text-gray font-bold uppercase">New Order</p>
                                            <p className="text-sm font-bold text-dark">LKR 4,550 Paid</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="absolute bottom-10 -left-4 bg-white p-4 rounded-2xl shadow-xl border border-border animate-pulse duration-[4000ms]">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center text-white">
                                            <BarChart3 size={20} />
                                        </div>
                                        <div>
                                            <p className="text-[10px] text-gray font-bold uppercase">Daily Revenue</p>
                                            <p className="text-sm font-bold text-dark">+LKR 124,000</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="bg-white py-24 border-t border-border">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
                        ...
                        <p className="text-gray">Simplify your operations with our suite of powerful tools designed for modern food businesses.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            ...
                            { title: 'Detailed Analytics', desc: 'Track sales, top items, and busy hours with real-time reporting.', icon: BarChart3, color: 'bg-primary' },
                            { title: 'Secure & Reliable', desc: 'Enterprise-grade security for your payments and customer data.', icon: ShieldCheck, color: 'bg-success' },
                        ].map((feature, i) => (
                            <div key={i} className="bg-light p-8 rounded-3xl border border-border hover:shadow-xl transition-all group">
                                ...
                                <p className="text-gray leading-relaxed text-sm">{feature.desc}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            {/* CTA Section */}
            <div className="py-24 px-6 bg-light">
                <div className="max-w-5xl mx-auto bg-[#0f172a] rounded-[3rem] p-12 lg:p-20 relative overflow-hidden text-center">
                    ...
                    <div className="relative space-y-8">
                        ...
                        <p className="text-slate-400 text-lg max-w-xl mx-auto">Join hundreds of owners who saved over 10 hours a week on administration.</p>
                        <div className="flex justify-center pt-4">
                            <Link to="/login">
                                <Button size="lg" className="bg-white text-[#0f172a] hover:bg-slate-100 px-10 py-5 rounded-2xl text-xl font-black shadow-2xl">
                                    Start Billing Now
            ...
            <footer className="py-12 border-t border-border bg-white">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <p className="text-gray text-sm">© 2024 QuickPOS Lite. All rights reserved.</p>
                    <div className="flex gap-8 text-sm font-bold text-gray">

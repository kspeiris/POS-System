                ...
                <div className="flex-1">
                        ...
                        <Card title="Shop Information" subtitle="Update your business details shown on receipts">
                            <form className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="md:col-span-2">
                                        <label className="text-sm font-medium text-dark block mb-1.5">Shop Logo</label>
                        ...
                        <Card title="Appearance" subtitle="Customize the look and feel of the POS">
                            <div className="space-y-6">
                                <div className="flex items-center justify-between p-6 bg-light rounded-2xl border border-border">
                                    <div className="flex items-center gap-4">
                                        <div className={`p-3 rounded-xl ${isDark ? 'bg-primary/10 text-primary' : 'bg-light text-gray'}`}>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-sm font-medium text-dark">Currency Symbol</label>
                                        <select className="rounded-xl border border-border bg-white py-2.5 px-3 text-sm outline-none focus:ring-2 focus:ring-primary/20">
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-sm font-medium text-dark">Timezone</label>
                                        <select className="rounded-xl border border-border bg-white py-2.5 px-3 text-sm outline-none focus:ring-2 focus:ring-primary/20">
                    ...
                    {activeTab === 'receipt' && (
                        <Card title="Receipt Settings" subtitle="Configure how receipts are printed">
                            <div className="space-y-6">
                                <div className="space-y-4">
                                    <label className="flex items-center justify-between p-4 bg-light rounded-2xl border border-border cursor-pointer hover:bg-white transition-all">
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-sm font-medium text-dark">Paper Size</label>
                                        <select className="rounded-xl border border-border bg-white py-2.5 px-3 text-sm outline-none focus:ring-2 focus:ring-primary/20">

        ...
        <header className="h-16 fixed top-0 left-0 right-0 z-20 border-b border-white/60 bg-white/80 backdrop-blur-xl px-4 sm:px-6 flex items-center justify-between shadow-[0_12px_40px_rgba(15,23,42,0.05)]">
            <Link to="/" className="flex items-center gap-3 text-lg font-bold text-dark">
                ...
                <div className="leading-tight">
                    ...
                    <div className="text-xs font-medium text-slate-500">Sri Lanka POS</div>
                </div>
            </Link>

            <div className="flex items-center gap-2 sm:gap-3">
                <Link to="/" className="hidden sm:flex items-center gap-2 text-slate-600 hover:text-primary font-semibold px-3 py-2 rounded-xl hover:bg-slate-100/80 transition-colors">

...
* **User Profiles:** Customize name and email details.
...
* **Checkout Modal:** Simple payment method selection (Cash, Card, QR) with quick-cash change calculation.
...
* **Tax & Settings:** Configure shop tax rates and general settings.
...
| Reports (Daily Sales) | Order History |
| :---: | :---: |
| ![Reports](./UI%20images/Reports%20(Daily%20Sales).png) | ![Order History](./UI%20images/Order%20History%20(Cashier.png) |
...
```bash
git clone https://github.com/kspeiris/POS-System.git
cd POS-System
```
...
│   │   ├── middleware/      # JWT protection & auth
...
├── frontend/
│   ├── src/
│   │   ├── api/             # Axios configurations & API modules
│   │   ├── components/      # Reusable POS components & UI elements
│   │   ├── context/         # Auth and Cart global state
│   │   ├── pages/           # Admin, Cashier, and shared pages
